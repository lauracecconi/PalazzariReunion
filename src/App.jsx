  ...
  return (
    <div className="min-h-screen font-body text-ink">
      ...
      <main>
        ...
        {page === 'organizers' && <Organizers />}
      </main>
      <footer className="border-t-2 border-ink/10 py-8 text-center text-sm text-ink/60 font-body">
        Con affetto, la famiglia Palazzari &middot; York Beach, Maine &middot; Summer 2027
        <br />
        <button
          onClick={() => setPage('organizers')}
          className="text-xs text-ink/30 hover:text-ink/50 mt-2 inline-block"
        >
          Organizers
        </button>
      </footer>
